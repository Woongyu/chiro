...
<body class="is-preload">
				...
				<section>
					...
					<form method="post" id="frm" name="frm" method="post" autocomplete="off">
						<div class="row gtr-uniform">
							...
							<div class="col-6 col-12-xsmall">
								<input type="email" readonly="readonly" name="EMAIL" id="EMAIL" value="${user.E_MAIL}" placeholder="E-MAIL" />
							</div>
							<div class="col-6 col-12-xsmall">
	...
	$(document).ready(function() {
		 $('input:checkbox[name="CHK01"]').each(function() {
		     if(this.value == "1"){
		            this.checked = true;
		      }
		 });
		 $('input:checkbox[name="CHK02"]').each(function() {
		     if(this.value == "1"){
		            this.checked = true;
		      }
		 });
		 $('input:checkbox[name="CHK03"]').each(function() {
		     if(this.value == "1"){
		            this.checked = true;
		      }
		 });
		 $('input:checkbox[name="CHK04"]').each(function() {
		     if(this.value == "1"){
		            this.checked = true;
		      }
		 });
