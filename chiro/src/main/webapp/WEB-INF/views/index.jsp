...
<body class="is-preload">
			...
			<div class="inner">
				...
				<section id="banner">
					<div class="content">
						...
						<ul class="actions">
							<li><a href="#this" class="button big" id="join">SIGN UP</a></li>
						</ul>
					</div>
				...
				<section id="banner">
					<div class="content">
						...
						<ul class="actions">
							<li><a href="#this" class="button big" id="edu">JOIN US</a></li>
						</ul>
					</div>
					<span class="image object">
				...
				<section id="banner">
					<div class="content">
						...
						<div id="carousel_section">
							<ul>
								<li> <img src="/images/modoo_pic01.jpeg"> </li>
								<li> <img src="/images/modoo_pic02.jpeg"> </li>
								<li> <img src="/images/modoo_pic03.jpeg"> </li>
								<li> <img src="/images/modoo_pic04.jpeg"> </li>
								<li> <img src="/images/modoo_pic05.jpeg"> </li>
								<li> <img src="/images/modoo_pic06.jpeg"> </li>
							</ul>
						</div>
					</div>
				</section>
				...
				<div class="content">
					...
					국제카이로치유연구소<br />
					서울시 마포구 도화동 4-48 2층 / 사업자등록번호 : 184-67-00219 / 전화번호 : 0507-1454-4391 / 기타 : 예약필수
					</blockquote>
				</div>
	...
	function fn_openJoinPage() {
		...
		comSubmit.setUrl("<c:url value='/openJoinPage.do' />");
		comSubmit.submit();
	}
	</script>
